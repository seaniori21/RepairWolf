...
<div class="body-content">
    <div class="container">
        <!-- form content -->
        <form action="{{ route('adminRolesEditSave', ['data' => $data->id]) }}" method="post">@csrf
            <div class="row">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                @foreach($permissions as $perm_id => $permission)
                                    ...
                                    <td>
                                        <div class="form-check mb-0">
                                          <input class="form-check-input" type="checkbox" name="permissions[]" {{ $data->hasPermissionTo($permission) ? 'checked' : '' }} value="{{ $permission }}" id="permission-check-{{ $group_simplify }}-{{ $perm_id }}">
                ...
                <div class="form-group col-12 mb-5">
                    <button type="submit" class="btn btn-success mt-0">Save Role Data</button>
