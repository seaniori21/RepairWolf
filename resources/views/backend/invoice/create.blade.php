...
<div class="body-content">
    <div class="container">
        <form action="{{ route('admin.invoice.create.post') }}" method="post">@csrf
            <div class="row">
                <!-- name -->
                <div class="col-sm-12">
                    <div class="input-group input-group-lg mb-3">
                      <span class="input-group-text" style="font-weight: bold;font-size: 18px;">Invoice #</span>
                      <input type="number" name="invoice_no" required class="form-control" value="10000" style="color: #a1a5b7 !important;height: 54px;font-size: 18px !important;font-weight: bold;">
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="input-group mb-3">
                      ...
                      <input type="date" required name="date" id="date" class="form-control" placeholder="Select Date">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group required mb-3">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input name="from_name" type="text" value="Green Leaf Building Services Ltd" class="form-control" placeholder="Bill from name">
                        </div>

                        <div class="input-group mb-3">
                          <span class="input-group-text">Email</span>
                          <input name="from_email" type="email" value="info@greenleafbuilding.co.uk" class="form-control" placeholder="Bill from email">
                        </div>

                        <div class="input-group mb-3">
                          <span class="input-group-text">Phone</span>
                          <input name="from_phone" type="text" value="0207-702-8771" class="form-control" placeholder="Bill from email">
                        </div>

                        <div class="input-group">
                          <span class="input-group-text">Address</span>
                          <textarea name="from_address" class="form-control note-textarea" placeholder="Bill from address" rows="2">Unit1, 32-34. Turner Street. London E1 2AS</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group required mb-3">
                        ...
                        <div class="input-group mb-3">
                            <select class="select-clients-multiple" name="client" id="client" multiple="multiple" style="width: 100%; display: hidden;">
                                ...
                                <option value="{{ $item->id }}" {{ $client_id ? intval($client_id) === $item->id ? 'selected' : '' : '' }}>
                                    {{ implode(' ', $names) }} - 
                        ...
                        <div class="input-group mb-3">
                          <span class="input-group-text">Name</span>
                          <input name="to_name" type="text" id="to_name_input" class="form-control" placeholder="Bill to name">
                        </div>                        

                        <div class="input-group mb-3">
                          <span class="input-group-text">Email</span>
                          <input name="to_email" type="email" id="to_email_input" class="form-control" placeholder="Bill to email">
                        </div>

                        <div class="input-group mb-3">
                          <span class="input-group-text">Phone</span>
                          <input name="to_phone" type="text" id="to_phone_input" class="form-control" placeholder="Bill to phone">
                        </div>

                        <div class="input-group">
                          <span class="input-group-text">Address</span>
                          <textarea name="to_address" id="to_address_input" class="form-control note-textarea" placeholder="Bill to address" rows="2"></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-borderless">
                          ...
                          <tbody style="font-weight: 200;" class="invoice-item-container">
                            ...
                            <tr class="invoice-row row-no-{{ $key }}">
                                <td>
                                    <input name="item[{{ $key }}][name]" type="text" class="form-control special-input mt-2" value="" placeholder="Item name" required>
                                    <textarea name="item[{{ $key }}][description]" class="form-control special-input my-2" value="" placeholder="Description" required></textarea>
                                </td>

                                <td>
                                    <input name="item[{{ $key }}][price]" type="number" value=""  min="0" step="0.01" class="form-control special-input mt-2 item-{{ $key }}-price" placeholder="0.00" required style="min-width: 100px">
                                </td>

                                <td>
                                    <input name="item[{{ $key }}][quantity]" type="number" value=""  min="0" class="form-control special-input mt-2 item-{{ $key }}-quantity" placeholder="--" style="min-width: 100px">
                                </td>

                                <td class="pt-4">
                                    <span class="item-currency-sign">$</span>
                                    <span class="item-{{ $key }}-total">0.00</span>
                                </td>
                ...
                <div class="col-xl-7 mb-4">
                    <button type="button" class="btn btn-dark btn-sm fs-6" id="add-invoice-item-btn" data-count="1">Add Invoice Item</button>
                </div>
                ...
                <div class="col-xl-5 mb-4">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <h6 class="pt-0 fw-semibold">
                            ...
                            <span class="item-1-total fs-16" id="subtotal-output">0.00</span>
                        </h6>
                    </div>
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center mt-2">
                        ...
                        <input name="tax" id="tax-input" type="number" value=""  min="0" step="0.01" class="form-control special-input mt-0 fs-6 p-0 px-1" placeholder="0.00" style="width: 100%;max-width: 100px;text-align: right;">
                    </div>

                    <div class="d-flex flex-row justify-content-between align-items-center mt-2">
                        <h6 class="fw-semibold mb-0">Discount</h6>

                        <input name="discount" id="discount-input" type="number" value=""  min="0" step="0.01" class="form-control special-input mt-0 fs-6 p-0 px-1" placeholder="0.00" style="width: 100%;max-width: 100px;text-align: right;">
                    </div>
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center mt-3 pt-2" style="border-top: 1px solid #e4e4e4;">
                        ...
                        <h6 class="pt-0 fw-semibold">
                            ...
                            <span class="item-1-total fs-18" id="total-output">0.00</span>
                        </h6>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-12 required mb-3">
                    ...
                    <textarea type="text" name="notes" id="notes" placeholder="Thanks for your business" class="form-control" required>Thanks for your business</textarea>
                </div>
