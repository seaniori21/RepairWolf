...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      ...
      <div id="project">
        <div><span>PROJECT</span><text> Website development</text></div>
        <div><span>CLIENT</span> <text>John Doe</text></div>
        <div><span>ADDRESS</span> <text>796 Silver Harbour, TX 79273, US</text></div>
        <div><span>EMAIL</span> <text><a href="mailto:john@example.com">john@example.com</a></text></div>
        <div><span>DATE</span> <text>August 17, 2015</text></div>
        <div><span>DUE DATE</span> <text>September 17, 2015</text></div>
      </div>
    </header>
    <main>
      <table>
