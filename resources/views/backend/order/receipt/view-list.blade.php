  ...
  <body style="margin: 40px 180px; position: relative;">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding: 10px 5px;text-align: right;">${{ $value->list_price ? number_format($value->list_price, 2) : number_format($value->base_price, 2) }}</td>
            <td style="padding: 10px 5px;text-align: right;">${{ number_format(($value->list_price ? $value->list_price : $value->base_price) * $value->quantity, 2) }}</td>
          </tr>
          @endforeach
          @else
          ...
          <tr>
            ...
            <td style="padding-top: 10px;" class="xtotal">${{ isset($data->list_total) ? number_format($data->list_total + $listTaxAmount + $data->convenience_fee, 2) : 0.00 }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding-top: 5px;" class="xtotal">${{ number_format(($data->list_total + $listTaxAmount + $data->convenience_fee)-$data->paid_amount, 2) }}</td>
          </tr>
          {{-- <tr>
    ...
    <div class="fixed">
        <div class="fixed-content">
            ...
            <a href="{{ route('admin.order.receipt.list.download', ['data' => $data->id]) }}" class="primary">Download PDF</a>
