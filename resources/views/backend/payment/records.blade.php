    ...
    <div class="container">
        <div class="header-title">
            <h3>
                ...
                <a href="{{ route('paymentTrashRecordsPage') }}" class="btn btn-danger btn-sm py-0">Trashed</a>
                @endif
            </h3>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <th class="no-sort text-end">
                        ...
                        <span class="header-action">
                            @if (Auth::user()->can('payment.delete'))
                            <a href="{{ route('ajaxPaymentRemoveMulti') }}" title="Delete" class="delete-all-confirm bg-danger text-white">
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <span class="table-action">
                            ...
                            <a href="{{ route('paymentUpdate', ['data' => $value->id]) }}" title="Edit">
                                <i class="icon ion-edit io-15"></i>
                            </a>
                            @endif

                            @if (Auth::user()->can('payment.delete'))
                            <a href="{{ route('paymentRemove', ['data' => $value->id]) }}" title="Delete" class='delete-confirm'>
                                <i class="icon ion-ios-trash io-18"></i>
                            </a>
                            @endif
                        </span>
...
@push('scripts')
    ...
    <script type="text/javascript">
        let exportable_column = [1,2,3,4,5,6,7,8,9];
    </script>
    @else
    <script type="text/javascript">
